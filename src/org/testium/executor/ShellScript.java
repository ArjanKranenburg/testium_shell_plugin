...
public class ShellScript
{
     ...
     */
    public static VERDICT execute( File aScript, File aRunLog ) throws FileNotFoundException
    {
     ...
     *         exist or are directories
     */
    public static VERDICT execute( File aScript, ParameterArrayList aParameters, File aRunLog ) throws FileNotFoundException
    {
...
//            	StreamGobbler(proc.getErrorStream(), errorLog);            
        ...
        catch (Throwable t)
        {
        	...
        	{
        		PrintWriter pw = new PrintWriter(runLog);
        		pw.println("Error while executing shell script:");
